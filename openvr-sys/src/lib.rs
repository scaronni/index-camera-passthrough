...
autocxx::include_cpp! {
    ...
    generate_pod!("vr::VREvent_AudioVolumeControl_t")
    generate_pod!("vr::VREvent_AudioMuteControl_t")
...
pub union VREvent_Data_t {
    ...
    pub audioVolumeControl: ManuallyDrop<ffi::vr::VREvent_AudioVolumeControl_t>,
    pub audioMuteControl: ManuallyDrop<ffi::vr::VREvent_AudioMuteControl_t>,
}
...
// Generated by build.rs from openvr.h.
include!(concat!(env!("OUT_DIR"), "/event_type.rs"));
