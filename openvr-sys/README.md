...
Raw bindings to the parts of [OpenVR](https://github.com/ValveSoftware/openvr) used by index_camera_passthrough, generated with [autocxx](https://github.com/google/autocxx).
